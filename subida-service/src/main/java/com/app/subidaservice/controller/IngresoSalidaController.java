...
public class IngresoSalidaController {
    ...
    @PostMapping
    public ResponseEntity<IngresoSalida> create(IngresoSalida ingresoSalida) {
        IngresoSalida nuevoIngresoSalida = ingresoSalidaService.crearIngresoSalida(ingresoSalida);
        return ResponseEntity.ok(nuevoIngresoSalida);
    }
}
